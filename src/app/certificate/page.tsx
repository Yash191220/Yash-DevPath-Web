...
export default function CertificatePage() {
    ...
    return (
        <div className="min-h-screen bg-[#0B0F19] text-white relative flex flex-col items-center">
            {/* Background Gradients - Fixed to Viewport to prevent scroll issues */}
            ...
            <div className="w-full pt-24 pb-12 px-4 relative z-10 flex flex-col items-center gap-12 lg:gap-24">
                ...
                {/* Rankings Section - Z-index ensure it's above fixed bg */}
